...
const PROVIDER_DESCRIPTORS: ProviderDescriptor[] = [
	...
	},
	{
		name: 'fabric',
		aliases: ['fabric'],
		description: 'Lightweight modded server using the Fabric loader',
		kind: 'modded',
		tab: 'modded',
		stable_name: 'Stable',
		unstable_name: 'Unstable',
	...
	{
		// Forge/NeoForge servers are created through modpack installs (their
		// installer has to run) or detected on import — not the version picker.
		name: 'neoforge',
		aliases: ['neoforge'],
		description: 'Modded server using the NeoForge loader',
		kind: 'modded',
		tab: 'modded',
		stable_name: 'Stable',
		unstable_name: 'Unstable',
	...
	{
		name: 'forge',
		aliases: ['forge', 'minecraftforge'],
		description: 'Modded server using the Forge loader',
		kind: 'modded',
		tab: 'modded',
		stable_name: 'Stable',
		unstable_name: 'Unstable',
