...
#[cfg(target_os = "windows")]
fn add_windows_firewall_rule(port: u16, protocol: &str, direction: &str) -> Result<String, String> {
...
#[cfg(target_os = "windows")]
fn firewall_rule_name(port: u16, protocol: &str, direction: &str) -> String {
    let way = if direction.eq_ignore_ascii_case("in") {
        "Inbound"
    } else {
        "Outbound"
...
#[cfg(target_os = "windows")]
fn forward_port_windows_firewall_elevated(port: u16) -> Result<Vec<String>, String> {
...
#[tauri::command]
fn forward_port_windows_firewall(port: u16) -> Result<Vec<String>, String> {
    if port == 0 {
...
#[tauri::command]
fn validate_path(path: String) -> Result<PathValidationResult, String> {
